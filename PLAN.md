...
>
> **Обновление 23.08.2026:** Этапы 1-4 закрыты полностью (FIX-1..18, FIX-20), FIX-29 из Этапа 6 — тоже.
> Открыто: FIX-19 (CI), весь Этап 5 (документация, FIX-21..25), FIX-26/27/28 из Этапа 6.
