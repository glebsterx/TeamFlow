...
>
> **Обновление 24.08.2026:** Этапы 1-5 закрыты полностью (FIX-1..25), FIX-29 из Этапа 6 — тоже.
> Открыто: FIX-26 (персистентные /remind), FIX-27 (разбить гигантские файлы), FIX-28 (sync I/O —
> хардкод порта закрыт другим способом, см. пункт). FIX-19 (CI) сделан без GitHub Actions —
