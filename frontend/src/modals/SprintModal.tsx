            ...
            <div>
              ...
              {allTasksDone && sprint.status && (
                <div className="mt-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                  ...
                  <button
                    onClick={() => {
                      sprintsApi.updateStatus(sprint.id, 'completed')
                        .then(() => { showToast('Спринт завершён', 'success'); onClose(); })
                        .catch(() => showToast('Ошибка при завершении', 'error'));
                    }}
