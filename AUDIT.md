...
- [x] **AUD-8 — Напоминания на `asyncio.create_task` теряются при рестарте.**
  ...
  **Закрыто 23.08.2026** — таблица `reminders` + `restore_reminders()` при старте бота (PLAN.md FIX-26, коммит `99bfd9e`).
